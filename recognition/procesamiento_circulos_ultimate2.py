# RECONOCIMIENTO DE CIRCULOS GRADO 4, 5, 6, 7, 8 y 9
...
def detectar_respuestas_estudiante(ruta_imagen, formato_columnas, dp_values=[1.002, 1.003, 1.004, 1.005, 1.007, 1.008, 1.009, 1.010, 1.012, 1.013, 1.014, 1, 0.999, 0.998, 0.997, 0.85]):
    ...
    for dp in dp_values:
        ...
        circulos = cv2.HoughCircles(roi_gray, 
                                    ...
                                    dp=dp, minDist=5,
                                    param1=40, 
                                    param2=18, # 18 para sexto, 17 el resto
                                    minRadius=5, 
                                    maxRadius=8)
        ...
        for idx_col, filas in enumerate(filas_columnas):
            ...
            for fila in alineadas:
                ...
                DENSIDAD_UMBRAL = 0.22 # 0.22 para los demas
...
if __name__ == "__main__":
    ruta = "C:/Users/valde/Desktop/image-recognition/assets/GRADO 904/8.jpg"
    formato = [24, 24, 24, 24, 24] # [17, 17, 17, 17, 15] formato tercero - [15, 15, 15, 13] formato segundo y primero
